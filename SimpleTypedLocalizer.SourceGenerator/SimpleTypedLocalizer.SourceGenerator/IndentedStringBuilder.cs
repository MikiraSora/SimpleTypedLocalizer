...
public class IndentedStringBuilder
{
    ...
    /// </param>
    /// <param name="values">
    ///     A collection that contains the objects to concatenate and append to the current instance of the
    ///     string builder.
    /// </param>
    /// <returns>This builder so that additional calls can be chained.</returns>
    ...
    /// <returns>This builder so that additional calls can be chained.</returns>
    public virtual IndentedStringBuilder AppendJoinIf<T>(IEnumerable<T> values, string separator,
        Func<IEnumerable<T>, bool>? condition = null)
    {
    ...
    ///     </para>
    ///     <para>
    ///         If the given string itself contains a new line, the part of the string after that new line will not be
    ///         indented.
    ///     </para>
    /// </summary>
    /// <param name="value">The string to append.</param>
    ...
    /// </summary>
    /// <param name="value">The string to append.</param>
    /// <param name="skipFinalNewline">
    ///     If <see langword="true" />, then the terminating new line is not added after the last
    ///     line.
    /// </param>
    /// <returns>This builder so that additional calls can be chained.</returns>
    ...
    ///     The condition delegate to evaluate. If condition is null, String.IsNullOrWhiteSpace method will
    ///     be used.
    /// </param>
    ...
    /// <summary>
    ///     Appends a copy of the specified string followed by the default line terminator if <paramref name="condition" /> is
    ///     met.
    /// </summary>
    /// <param name="text">The string to append.</param>
    /// <param name="condition">
